...
var Pyrite = /** @class */ (function () {
    function Pyrite(params) {
        ...
        this.params = params;
        if (params.inject) {
            var names_1 = Object.keys(params.inject);
            var promises = names_1.map(function (name) { return params.inject[name]; });
            Promise.all(promises)
                .then(function (values) {
                values.forEach(function (value, index) {
                    var name = names_1[index];
    ...
    Pyrite.prototype.render = function () {
        var _this = this;
        setTimeout(function () { return m.route(document.body, "/", _this.params.routes); });
    };
    return Pyrite;
}());
...
function Component(template) {
    return function (target, method, descriptor) {
        function newTarget() {
            var _this = this;
            var injects = target.prototype.__inject;
            if (injects) {
                injects.forEach(function (inject) {
                    target.prototype[inject.method] = getDescendantProp(pyrite_1.Injections, inject.name);
                });
...
Object.defineProperty(exports, "__esModule", { value: true });
var connect_1 = __webpack_require__(31);
    ...
    buildControllers(controllersAllowed) {
        ...
        controllerNames.forEach((controllerName) => {
            ...
            methods.forEach((methodName) => {
                ...
                controllers[controllerName][methodName] = (params) => {
                    if (this.plugins) {
...
Object.defineProperty(exports, "__esModule", { value: true });
const Chat_1 = __webpack_require__(61);
exports.router = {
    "/": Chat_1.Chat
};
